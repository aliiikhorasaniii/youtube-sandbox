...
این مخزن با استفاده از **GitHub Actions** بهت اجازه می‌ده فقط با **ارسال لینک یوتیوب تو پیام کامیت**، ویدیو به‌صورت خودکار دانلود بشه و توی مخزن ذخیره بشه.
...
> برای استخراج فایل‌های بزرگ، همه قسمت‌ها رو توی یک پوشه بگذار و روی فایل `.zip` راست‌کلیک کن و Extract بزن.

<br>

## 💡 نکات اضافی

- اگر دانلود شد ولی چیزی کامیت نشد یعنی ویدیو قبلاً دانلود شده.
